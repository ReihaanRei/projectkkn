<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="nama_admin" name="nama_admin" type="text" class="mt-1 block w-full" :value="old('nama_admin', $user->name)" required autofocus autocomplete="nama_admin" />
