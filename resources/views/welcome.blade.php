...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex flex-col items-center justify-start min-h-screen ">
        ...
        <div class="max-w-full px-8 py-4 flex justify-between items-center">
            ...
            @if (Route::has('login'))
                <div class="flex items-center gap-2">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-sm btn-error text-white">Login</a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="btn btn-sm btn-outline border-white text-white">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
    ...
    <main class="w-full max-w-7xl bg-base-100 shadow-xl rounded-box p-6">
        <h2 class="text-xl font-semibold text-primary mb-6">Data Siswa Berprestasi</h2>

        <div class="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
            <input type="text" placeholder="Cari nama siswa..." class="input input-bordered w-1/2 col-span-3" />
            ...
            <table class="table table-zebra w-full">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="/certificates/sample.pdf" target="_blank" class="btn btn-sm btn-outline btn-info">
                                Lihat Sertifikat
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><span class="italic text-gray-400">Belum diupload</span></td>
                    </tr>
                </tbody>
            </table>
        </div>
